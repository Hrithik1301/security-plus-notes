...
Functionalities
     ...
     2. control of inappropriate content (NSFW, Parental controls)
...
**Unified Threat Management Device (UTM)** : Older firewalls with additional functionalities, also called as  Web Security Gateway ---> Functionalities are as follows
